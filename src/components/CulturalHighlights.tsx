...
const CulturalHighlights = () => {
  const highlights = [
    {
      title: "Амурский тигр",
      subtitle: "Символ дикой природы",
      description: "Редчайший подвид тигра, обитающий в лесах Приморья",
      image:
    ...
    },
    {
      ...
      subtitle: "Традиционное искусство",
      description: "Древние орнаменты коренных народов Амура",
      image:
    ...
    {
      title: "Владивосток",
      subtitle: "Город у моря",
      description: "Столица Приморья и ворота в Азию",
      image:
